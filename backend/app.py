...
from routes import agent, ai_configs, annotations, assets, auth, cloud_storage, dashboard, export, pair_candidates, prompt_pairs, repo_templates, repos, scheduled_tasks, search, skill_repo_profiles, tags, web_ui_prompts, web_ui_repo_profiles
from routes import repo_scan_runs
from services.annotation_service import start_annotation_worker, stop_annotation_worker
from services.cloud_storage_service import start_cloud_upload_worker, stop_cloud_upload_worker
...
async def lifespan(app: FastAPI):
    ...
    start_cloud_upload_worker()
    try:
        yield
    finally:
        await stop_cloud_upload_worker()
